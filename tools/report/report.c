 ...
 * discharged when all of those are, and reported as held back by whichever
 * one is not.
 *
...
static const claim_t CLAIMS[] = {
    ...
    { "C2",  "architecture relies on MQTT", "Abstract, III",
      "adapters/mqtt/fdt_mqtt.c", ST_ARTEFACT },
    { "C3",  "integrates Ardupilot, WeBots, other simulations", "Abstract",
      "adapters/mavlink/fdt_mavlink.c", ST_ARTEFACT },
    ...
    { "C8",  "near-real-time 3D reference", "I (iii)",
      "adapters/webots/fdt_webots_controller.c", ST_ARTEFACT },
...
int main(void)
{
    ...
    fprintf(out, "Generated by `make report` from the artefacts in "
                 "`results/`. Every figure below\ncomes from a run on the "
                 "machine that produced this file; nothing is quoted from\n"
                 "the paper except where a line is labelled `paper:`.\n\n");
